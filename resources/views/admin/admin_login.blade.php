...
<head>
    ...
    <title>Neer Qualite Admin</title>
    <!-- Custom CSS -->
                ...
                <div id="loginform">
                    ...
                    @if(Session::has('flash_message_error'))
                        <div class="alert alert-danger" role="alert">
                            <i class="close fa fa-times" data-dismiss="alert"></i>
                    ...
                    @endif
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" method="post" action="{{url('admin')}}">
                        @csrf
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input name="email" type="email" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
